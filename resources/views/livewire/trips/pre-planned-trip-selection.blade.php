    ...
    <div class="space-y-3">
        ...
        <div class="pt-3 border-t border-green-300 flex justify-between text-lg font-bold">
            ...
            <span class="text-green-800">${{ number_format($totalPrice, 2) }}</span>
                        ...
                        <div class="mt-6">
                            <button wire:click="selectTripTemplate" type="button" class="w-full inline-flex justify-center items-center px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700">
