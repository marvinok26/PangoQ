...
@section('title', 'Create Account - PangoQ')

@section('page-title', 'Join PangoQ')
@section('page-subtitle', 'Create an account to start planning your dream trips')
...
@section('content')
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="mt-2 text-sm text-gray-600">Join thousands of travel enthusiasts today</p>
                    </div>
                    ...
                    <div class="relative my-8">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white text-gray-500 font-medium">Or create an account with email</span>
                        </div>
                    </div>
    ...
    <div class="mb-4 p-4 rounded-lg bg-blue-50 border border-blue-200">
        <div class="flex">
            <svg class="h-5 w-5 text-blue-600 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-1 9a1 1 0 ai-1-1v-4a1 1 0 112 0v4a1 1 0 01-1 1z" clip-rule="evenodd" />
            </svg>
