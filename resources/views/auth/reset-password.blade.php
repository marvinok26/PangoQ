...
@section('title', 'Set New Password - PangoQ')
    
@section('page-title', 'Create a new password')
@section('page-subtitle', 'Please create a secure password for your account')
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Create a new secure password for your PangoQ account</p>
                </div>
